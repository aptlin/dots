#+TITLE: Sasha Delly's Emacs configuration
#+OPTIONS: toc:4 h:4
...
Inspired by the [[https://eschulte.github.io/emacs24-starter-kit/#installation][Emacs Starter Kit]], I set up my configuration file
using Org-babel.This page: [[http://sachac.github.io/.emacs.d/Sacha.html][HTML]] - [[Https://github.com/sachac/.emacs.d/blob/gh-pages/Sacha.org][Org]] - [[Https://dl.dropbox.com/u/3968124/sacha-emacs.el][.el]] - [[http://github.com/sachac/.emacs.d/][Github]] - also, http://sach.ac/dotemacs. My =~/.emacs.d/init.el= is now a symlink to =Sacha.el=, which is what =M-x org-babel-tangle= (=C-c C-v t=) produces.
...
#+RESULTS:
| ~/.emacs.d/themes | /home/aleph/.emacs.d/elpa/smart-mode-line-20160818.508/ | custom-theme-directory | t |

*** no splash screen and a message in the echo area
...
#+begin_src emacs-lisp tangle: yes
(setq save-place-file "~/elisp/saveplace")
...
#+END_SRC
*** Create new file in a different frame
#+begin_src emacs-lisp :tangle yes
(defun create-new-buffer-frame ()
  ...
  (let ((buffer (generate-new-buffer "untitled")))
    ...
    (global-set-key (kbd "C-c n") #'create-
*** new-buffer-frame)
#+end_src
...
Insert other files as they are in a block
...
* [#B] Other cool configs you may want to check out
...
#+begin_src emacs-lisp :eval no :tangle no
  (use-package org-mobile :disabled t
    ...
    (progn
      ...
      (setq org-mobile-inbox-for-pull "~/LOG/mobileorg.org")
      (setq default-buffer-file-coding-system 'utf-8)
      (setq org-mobile-files '("/cygdrive/c/my/LOG/organizer.org"
                               "/cygdrive/c/my/LOG/business.org"
                               "/cygdrive/c/my/LOG/books.org"))
