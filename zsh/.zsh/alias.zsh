...
alias ae="vim ~/.zsh/environment.zsh && source ~/.zsh/environment.zsh; git commit -m 'added new env vars' ~/DOTS/zsh/.zsh/environment.zsh; git push ~/DOTS/"
alias ale="ec ~/.zsh/alias.zsh && source ~/.zsh/alias.zsh; git commit -m 'added aliases' ~/DOTS/zsh/.zsh/alias.zsh; git push ~/DOTS/"
alias aee="ec ~/.zsh/environment.zsh && source ~/.zsh/environment.zsh; git commit -m 'added new env vars' ~/DOTS/zsh/.zsh/environment.zsh; git push ~/DOTS/"
alias dot="cd ~/DOTS"
